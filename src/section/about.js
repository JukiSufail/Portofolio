...
export const About = (props) => {
  ...
  const year = date.getFullYear()
   const enTitle = (<p className='text-yellow-200 text-2xl lg:text-5xl font-bold mt-3'>About <span className='text-gray-800'>Me</span></p>) 
   const idTitle = (<p className='text-yellow-200 text-2xl lg:text-5xl font-bold mt-3'>Tentang <span className='text-gray-800'>Saya</span></p>) 
    ...
    background: "linear-gradient(to bottom, #FFB6C1,#8A2BE2,#4682B4)", 
      ...
      <div className='h-fit lg:h-full grid'>
        <div className='justify-center justify-self-center self-end grid content-center w-4/5 lg:w-2/3'>
          ...
          <p className='text-yellow-200 tracking-wide text-sm lg:text-lg my-4 lg:my-0'>{d}</p>
        </div>
        <div className='h-full grid mb-8 lg:mb-0'>
          <div className='justify-self-center self-start mt-5 lg:mt-20 grid w-4/5 lg:w-2/3'>
            <div className='text-white tracking-wide text-lg'>
              <a href='https://www.facebook.com/profile.php?id=100017650604051&locale=id_ID' className='w-full flex items-center rounded border-2 border-blue-200 border-opacity-10 shadow-xl rounded-xl p-2  mb-3 bg-opacity-10 hover:bg-opacity-20' style={{ backgroundColor: '#15148e' }}>
